    ...
    def test_valid_offset_with_seconds(self):
        assert OffsetDateTime.from_canonical_format(
            ...
            OffsetDateTime(
                ...
                8,
                30,
                offset=Duration(hours=5, seconds=33),
            )
        )
    ...
    def test_valid_six_fractions(self):
        assert OffsetDateTime.from_canonical_format(
            ...
            OffsetDateTime(
                ...
                30,
                349_123,
                offset=Duration(hours=5, seconds=33, microseconds=987_654),
            )
        )
...
def test_repr():
    d = OffsetDateTime(
        ...
        9,
        987_654,
        offset=Duration(hours=5, minutes=22),
    )
...
class TestSubtract:
    ...
    def test_offset(self):
        ...
        assert d - other == Duration(hours=16, seconds=5)

    def test_utc(self):
        d = OffsetDateTime(2020, 8, 15, 20, offset=hours(5))
        assert d - UTCDateTime(2020, 8, 15, 20) == -Duration(hours=5)
    ...
    def test_local(self):
        ...
        assert d - LocalDateTime(2023, 10, 29, 1) == Duration(hours=5)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "%Y-%m-%d %H:%M%z",
            OffsetDateTime(
                2020, 8, 15, 23, 12, offset=Duration(hours=3, minutes=15)
            ),
        ),
        (
            ...
            OffsetDateTime(
                ...
                12,
                9,
                offset=Duration(hours=5, minutes=50),
            ),
        ),
        (
            "2020-08-15 23:12:09Z",
            "%Y-%m-%d %H:%M:%S%z",
            OffsetDateTime(2020, 8, 15, 23, 12, 9, offset=Duration()),
        ),
    ],
)
